      ...
      .then((data) => {
        if (data.success && data.caregiver) {
          ...
          setCaregiver({
            ...
            isJobSeeking: false,
            isActive: false,
            jobInfo: { hourlyWage: 0, days: [], times: [] },
          });
        }
      })
      .catch((error) => {
                ...
                <div key={index} className="bg-white p-5 rounded-2xl shadow-md mb-4 w-full max-w-md border border-gray-200">
                  ...
                  <div className="flex justify-between mt-4 w-full">
                    ...
                    <button
                      ...
                      onClick={() => setSelectedChatElder(elder.id)}
                    >
                      대화하기
                    </button>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-80 text-center h-80">
            ...
            <div className="mt-5 flex flex-col gap-2">
              ...
              <button
                className="bg-[#FF8B14] text-white p-3 rounded-lg text-sm font-semibold"
                onClick={() => router.push(`/chat?elderId=${selectedChatElder}`)}
              >
                네, 대화 시작할게요
              </button>
              ...
              {/* 취소 버튼: 모달 닫기 */}
              <button
                className="border border-gray-200text-gray-600 p-3 rounded-lg text-sm"
