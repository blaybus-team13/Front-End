...
export default function RegisterPage() {
  ...
  const role = searchParams.get("role") || ""; // ✅ URL에서 role 값 가져오기
    ...
    <div className="min-h-screen bg-gray-50 px-6 py-4 relative">
      ...
      <div className="mt-6 text-center">
        ...
        <button
          ...
          onClick={() => router.push(`/register/custom-center?role=${role}`)} // ✅ role 유지
        >
          직접 센터 등록하기
        </button>
      </div>
          ...
          <div className="bg-white p-6 rounded-t-2xl shadow-lg w-full max-w-md">
            ...
            <div className="flex justify-between mt-4">
              <button
                ...
                onClick={() => {
                  setShowModal(false);
                  router.push(`/register/name?role=${role}`); // ✅ role 유지 후 이동
                }}
              >
                맞아요
              </button>
