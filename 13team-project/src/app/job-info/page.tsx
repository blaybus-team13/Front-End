          ...
          {days.map((day) => (
            <button
              ...
              className={`p-3 rounded-full font-medium ${
                selectedDays.includes(day) ? "bg-[#FF8B14] text-white" : "border border-gray-300 text-gray-700"
              }`}
            >
              {day}
            </button>
        ...
        <div className="grid grid-cols-1 gap-3 mt-6 w-full max-w-md">
          {times.map((time) => (
            <button
              ...
              className={`p-3 rounded-full font-medium ${
                selectedTimes.includes(time) ? "bg-[#FF8B14] text-white" : "border border-gray-300 text-gray-700"
              }`}
            >
              {time}
            </button>
