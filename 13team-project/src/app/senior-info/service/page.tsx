...
export default function JobPostingPage() {
  ...
  const handleNext = async (event: React.FormEvent) => {
    ...
    console.log("📌 기존 데이터:", elderData);
  
    // 데이터 변환 (dementiaSymptoms가 배열인지 확인)
    if (!Array.isArray(elderData.elderly.dementiaSymptoms)) {
      console.error("❌ dementiaSymptoms가 배열이 아님!", elderData.elderly.dementiaSymptoms);
      alert("치매 증상이 올바르게 저장되지 않았습니다. 다시 시도해 주세요.");
      return;
    }
    ...
    console.log("🚀 저장할 데이터:", fullElderData);
